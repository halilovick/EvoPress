...
This report compares five 20-generation sequential conditions, including both mutation operators for quantization-first warm starts, with a matched standard-initialization interaction-aware G20 control. The completed depth-warm interaction-aware G50 study remains a separately labeled reference. Lower WikiText2 PPL is better.
...
The generator verified 15 G20 sequential summaries, three matched standard-initialization interaction-aware G20 controls, and the three depth-warm interaction-aware G50 summaries, including exact depth counts, active quantization budgets, stage-one provenance hashes, and frozen-component invariants. Both quantization-first warm-start conditions used strict initialization and changed zero imported genes before initial selection.
...
This is a 3.52% mean PPL improvement over independent composition and a 8.57% improvement over standard joint G20. Standard-initialization interaction-aware G50 reaches 11.086 mean PPL; its matched depth-warm counterpart reaches 11.172. At G20, quant-warm interaction-aware differs from its matched standard-init control by -0.286 PPL on average. G50 results remain explicitly separated from G20.
...
| Standard-init + standard mutation (G20) | standard-initialization standard-mutation G20 control | 3 | 12.607 ± 0.675 | 0.00 | 10.15 | 10.15 |
| Standard-init + interaction-aware (G20) | matched standard-initialization interaction-aware G20 control | 3 | 12.133 ± 0.508 | 0.00 | 9.54 | 9.54 |
...
| Seed | Depth→Quant frozen | Depth→Joint standard G20 | Depth→Joint interaction G50 | Quant→Depth frozen | Quant→Joint standard G20 | Quant→Joint interaction G20 | Independent | Standard-init standard G20 | Standard-init interaction G20 | Joint G50 | Interaction-aware G50 |
| ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 0 | 11.922 | 11.508 | 10.984 | 11.031 | 13.047 | 12.398 | 11.970 | 13.383 | 11.625 | 11.469 | 10.898 |
| 1 | 12.523 | 11.758 | 11.375 | 16.453 | 12.180 | 11.805 | 12.520 | 12.281 | 12.641 | 10.922 | 11.117 |
| 2 | 11.352 | 11.312 | 11.156 | 14.523 | 12.492 | 11.336 | 11.350 | 12.156 | 12.133 | 11.336 | 11.242 |
...
| Depth → Quantization, frozen | Standard-init + standard mutation (G20) | -0.674 ± 0.859 | 2/3 |
...
| Depth → Joint warm + standard (G20) | Standard-init + standard mutation (G20) | -1.081 ± 0.706 | 3/3 |
...
| Quantization → Depth, frozen | Standard-init + standard mutation (G20) | +1.396 ± 3.368 | 1/3 |
...
| Quantization → Joint warm + standard (G20) | Standard-init + standard mutation (G20) | -0.034 ± 0.341 | 2/3 |
...
| Quantization → Joint warm + interaction-aware (G20) | Standard-init + standard mutation (G20) | -0.760 ± 0.259 | 3/3 |
...
| --- | ---: | ---: | --- |
| Quant warm interaction-aware G20 − standard-init interaction-aware G20 | -0.286 ± 0.918 | 2/3 | Same interaction-aware operator and G20 budget; initialization changes. |
...
| Standard-init interaction-aware G20 − standard-init standard G20 | -0.474 ± 1.128 | 2/3 | Same standard initialization and G20 budget; mutation operator changes. |
...
Candidate evaluations count nominal search-fitness evaluations across initialization and progressive selection, including the final-stage parent evaluation. Token exposure multiplies each evaluation by its configured calibration-token stage; final PPL evaluation is excluded.

| Method | Stage 1 min | Stage 2 min | End-to-end min | Stage 2 evals | Stage 2 tokens | End-to-end evals | End-to-end tokens |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard-init + standard mutation (G20) | 0.00 | 10.15 | 10.15 | 572 | 999424 | 572 | 999424 |
| Standard-init + interaction-aware (G20) | 0.00 | 9.54 | 9.54 | 572 | 999424 | 572 | 999424 |
| Quantization → Joint warm + standard (G20) | 13.15 | 9.01 | 22.16 | 572 | 999424 | 1144 | 1998848 |
| Quantization → Joint warm + interaction-aware (G20) | 13.15 | 11.39 | 24.54 | 572 | 999424 | 1144 | 1998848 |
...
- With interaction-aware mutation and G20/O16 fixed, the quantization warm start changes mean PPL by -0.286 relative to standard joint initialization and wins 2/3 seeds.
- With standard initialization and G20/O16 fixed, switching from standard to interaction-aware mutation changes mean PPL by -0.474 and wins 2/3 seeds.
